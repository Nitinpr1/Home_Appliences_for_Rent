<%@ Page Title="" Language="C#" MasterPageFile="~/user/userMaster.Master" AutoEventWireup="true" CodeBehind="Furniture.aspx.cs" Inherits="Home_Appliences_for__rent.user.Furniture" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<title>RentSpace | Furnitures</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse " id="navbarText">
                        <ul class="navbar-nav  me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-primary px-2 me-lg-3" href="Furniture.aspx">Furniture</a>
                            </li>
                            <li class="nav-item">
