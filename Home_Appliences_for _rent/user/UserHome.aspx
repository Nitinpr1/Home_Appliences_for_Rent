<%@ Page Title="" Language="C#" MasterPageFile="~/user/userMaster.Master" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="Home_Appliences_for__rent.user.UserHome" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <title>RentSpace | Home</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse " id="navbarText">
                        ...
                        <span class="navbar-text me-lg-5">
                            ...
                            <asp:Button ID="Btnlogout" class="  btn btn-outline-primary" runat="server" Text="Sign-Out" OnClick="Btnlogout_Click" />
                        </span>
                    </div>
                </div>
            </nav>
            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="NewFolder1/homeap.png" class="d-block w-100" alt="..." />
                    </div>
                    <div class="carousel-item">
                        <img src="NewFolder1/homeap1.jpg" class="d-block w-100" alt="..." />
                    </div>
                    <div class="carousel-item">
                        <img src="imga.jpg" class="d-block w-100" alt="..." />
                    </div>
                </div>
                            ...
                            <a href="ViewProduct.aspx?Pid=<%# Eval("Pid") %>" style="text-decoration: none; color: black;">
                                <div class="card h-100 sitems">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button id="btnview" class="btn btn-sm btn-primary float-end ffbtn" onclick="#">Add to Cart</button>
